package com.ironhack.tfdtheorycraftbuild.securityfolder.security;

import com.ironhack.tfdtheorycraftbuild.securityfolder.security.filters.CustomAuthorizationFilter;
import com.ironhack.tfdtheorycraftbuild.securityfolder.security.filters.CustomAuthenticationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(GET, "/builds").permitAll()
                .requestMatchers("/characters").hasAnyAuthority( "ROLE_ADMIN")
